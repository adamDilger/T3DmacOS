...
namespace T3D {
    ...
    Lamp::Lamp(T3DApplication *app):GameObject(app) {
        ...
        t.setLocalRotation(*new Quaternion(Vector3(0,Math::PI/2,0)));
        ...
        baseJoint->getTransform()->setLocalRotation(*new Quaternion(Vector3(Math::PI/7,0,0))); // this rotation is just to make a good starting pose
        ...
        elbowJoint->getTransform()->setLocalRotation(*new Quaternion(Vector3(Math::PI/4,0,0))); // this rotation is just to make a good starting pose
